...
export function getScenes(device_name: string): { [key: string]: Scene; } {
    let main_scenes = {
        ...
        "front_light_flicker": new FrontLightFlickerScene(getLights("front_walkway").concat(getLights("downstairs_entry"))),

        // Hank's scenes
        "down_bath_random": get_downstairs_bathroom_scene(getLights("downstairs_bathroom")), // TODO
        // Bill's scenes
