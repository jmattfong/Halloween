...
export async function sendSensorEvent(clientUri: string, sensorId: string, sensorType: SensorType, data: boolean) {
    const event: SensorUpdateEvent = new SensorUpdateEvent(sensorId, sensorType, data);
